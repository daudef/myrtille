...
CREATE TABLE `password_history` (
  `Host` char(255) CHARACTER SET ascii COLLATE ascii_general_ci NOT NULL DEFAULT '',
  `User` char(32) COLLATE utf8_bin NOT NULL DEFAULT '',
  `Password_timestamp` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE `proxies_priv` (
  ...
  `With_grant` tinyint NOT NULL DEFAULT '0',
  `Grantor` varchar(288) COLLATE utf8_bin NOT NULL DEFAULT '',
  `Timestamp` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE `replication_group_member_actions` (
  ...
  `enabled` tinyint NOT NULL COMMENT 'Whether the action is enabled.',
...
CREATE TABLE `slave_master_info` (
  ...
  `Enabled_ssl` tinyint NOT NULL COMMENT 'Indicates whether the server supports SSL connections.',
  `Ssl_ca` text CHARACTER SET utf8 COLLATE utf8_bin COMMENT 'The file used for the Certificate Authority (CA) certificate.',
  `Ssl_capath` text CHARACTER SET utf8 COLLATE utf8_bin COMMENT 'The path to the Certificate Authority (CA) certificates.',
  `Ssl_cert` text CHARACTER SET utf8 COLLATE utf8_bin COMMENT 'The name of the SSL certificate file.',
  `Ssl_cipher` text CHARACTER SET utf8 COLLATE utf8_bin COMMENT 'The name of the cipher in use for the SSL connection.',
  `Ssl_key` text CHARACTER SET utf8 COLLATE utf8_bin COMMENT 'The name of the SSL key file.',
  `Ssl_verify_server_cert` tinyint NOT NULL COMMENT 'Whether to verify the server certificate.',
  ...
  `Enabled_auto_position` tinyint NOT NULL COMMENT 'Indicates whether GTIDs will be used to retrieve events from the master.',
  ...
  `Get_public_key` tinyint NOT NULL COMMENT 'Preference to get public key from master.',
  ...
  `Source_connection_auto_failover` tinyint NOT NULL DEFAULT '0' COMMENT 'Indicates whether the channel connection failover is enabled.',
  `Gtid_only` tinyint NOT NULL DEFAULT '0' COMMENT 'Indicates if this channel only uses GTIDs and does not persist positions.',
...
CREATE TABLE `slave_relay_log_info` (
  ...
  `Require_row_format` tinyint NOT NULL COMMENT 'Indicates whether the channel shall only accept row based events.',
...
) /*!50100 TABLESPACE `mysql` */ ENGINE=InnoDB AUTO_INCREMENT=597 DEFAULT CHARSET=utf8mb3 STATS_PERSISTENT=0 ROW_FORMAT=DYNAMIC COMMENT='Time zones'
